"""Ollama Automations + Pipelines tiles. No BrainRot imports."""

from __future__ import annotations

from typing import Any

NODES = ("ollama.complete",)
...
def handle_complete(ctx: dict[str, Any]) -> dict[str, Any]:
    ...
    return complete_prompt("ollama", prompt, model)


def register_nodes(api: Any) -> None:
    if not hasattr(api, "register_pipeline_node"):
        return
    api.register_pipeline_node("ollama.complete", handle_complete)
